...
First, dataset is cleaned and prepared by converting the data type, filtering the useful info, and deleting the irrelavant field.
...
cat("The Proportion of User Types\n")
user_proportion
```
